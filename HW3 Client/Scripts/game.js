GAME = [
    ...
    },
    {
      ...
      "Price": 1.99,
      "description": "Treasure awaits within the dungeon! There are no guards... but the dungeon was built to protect itself until the end of time, its traps operating like clockwork! Your task is to get the gold and escape alive! The order in which the traps trigger is known in advance, so it is up to you to plan your path to the treasure... and then back again to the exit... Good luck and beware of the traps. Deadly Spikes Flaming Walls Breaking Floors ...And moreâ€¦ to be discovered! FEATURES: 20 hand crafted levels Solve unique puzzles harder than they initially seem Increasing difficulty and complexity A secret hidden bonus level Achievements Full original soundtrack",
      "Full_audio_languages": "['English']",
    ...
    },
    {
      ...
      "Score_rank": 57,
      "Recommendations": "",
      "Developers": "SGãƒ‡ãƒ™ãƒ­ãƒƒãƒ‘ãƒ¼",
    ...
    },
    {
      ...
      "Price": 11.99,
      "description": "Â«DupioÂ» â€” is a fast and challenging non-stop arcade, with minimalistic gameplay. You must play contemporaneously both hands. The game has two screens with purple main characters. The right character is controlled by the mouse.The left hero controlled by keyboard. Avoid red spikes and collect the green circles, survive as long as possible and break your own record. |CONTROL OF THE RIGHT HERO| â— Mouse |CONTROL OF THE LEFT HERO| â— [W] - Move Up â— [S] - Move Down â— [D] - Move Right â— [A] - Move Left produced by",
      "Full_audio_languages": "['English']",
    ...
    },
    {
      ...
      "Price": 4.24,
      "description": "Welcome to Realms VR Experience a variety of different worlds whilst racing or fighting online through time and space. Over 30 levels Continuously growing Realms to explore including currently The Wild West, Vikings, Future, Pirates and Modern Times. Steal, Shoot / Fight or Race other players in a variety of game modes within the ever expanding Realms VR Universe. Game Modes Include Waves - Fight a hordes of zombies/Cowboys/Robots/Ice Goblins/Ships in the 6 NEW Maps. 4 Player Co-op or Go Solo. BattleShips - Fight your friends a cross 3 Pirate maps sailing your own Ship to victory. Race - Race through levels based on different Realms while trying to dodge obstacles unique to each timeline. Rumble - Engage with up to 8 players to achieve the highest score in the allotted time using special Realm based weapons ranging from axes to laser rifles. Rumble Squads - Work as a team to defeat the enemy to the chosen score limit in your desired Realm Steal â€˜em - Compete against 4 players to obtain the highest score by locating and storing the Realm items in your home base. Be sure to search your enemies bases as they may have hidden the higher priced loot.",
      "Full_audio_languages": "['English']",
    ...
    {
      "AppID": 1023420,
      "Name": "å››å›½å¿—ã§ã‚‰ã£ãã™ ï½žé…’æ± è‚‰ã†ã©ã‚“æˆ¦è¨˜ï½ž",
      "Release_date": "Jul 31, 2020",
      "Price": 24.99,
      "description": "â€»å¯¹äºŽä¸­æ–‡ç‰ˆæœ¬ï¼Œæœç´¢â€œå››å›½å¿— ï½žé…’æ± è‚‰é¢æˆ˜è®°ï½žâ€ â€»ä¸­å›½èªžç‰ˆã¯ã€Œå››å›½å¿— ï½žé…’æ± è‚‰é¢æˆ˜è®°ï½žã€ã§æ¤œç´¢ã—ã¦ãã ã•ã„ã€‚ _________________________________ è«¸å›ã®ç›®çš„ã¯â€¦â€¦ã€‚ å››å›½ã‚’åˆ¶åœ§ã—ã€ãƒ’ãƒ­ã‚¤ãƒ³ã¨ã„ã£ã—ã‚‡ã«è¦³å…‰ã—ãŸã‚Šã€ã‚°ãƒ«ãƒ¡ã‚’æº€å–«ã—ã¾ãã‚‹äº‹ã§ã‚ã‚‹! ã•ã‚ã€å››å›½ã®è¦‡è€…ã¨ãªã‚Šã€ã„ã–è±ªéŠã›ã‚ˆ! â– ã‚¹ãƒˆãƒ¼ãƒªãƒ¼ ç‰©èªžã®èˆžå°ã¯ã€åœ°åŸŸåˆ†æ¨©ãŒé€²ã¿ã€å„çœŒãŒç‹¬ç«‹å›½ã¨ãªã£ãŸå››å›½ã€‚ ä¸»å½¹ã¯é¦™å·çœŒã®çŸ¥äº‹ã€Œæµ¦å³¶æ¬¡éƒŽã€ã¨å‰¯çŸ¥äº‹ã€Œå¥³æœ¨é¬¼å§«ã€ã€‚ äºŒäººã¯é¦™å·çœŒã®è²¡æ”¿ç ´ç¶»ã‚’å›žé¿ã™ã‚‹ãŸã‚ã€ãã—ã¦è¦³å…‰ã—æ”¾é¡Œã€ã‚°ãƒ«ãƒ¡é£Ÿã¹æ”¾é¡Œç›®æŒ‡ã—ã¦ã€å››å›½çµ±ä¸€ã«é‚é€²ã™ã‚‹! â– ã‚²ãƒ¼ãƒ ã‚·ã‚¹ãƒ†ãƒ  åœ°åŸŸåˆ¶åœ§åž‹ã‚·ãƒŸãƒ¥ãƒ¬ãƒ¼ã‚·ãƒ§ãƒ³ãªã‚‰ã¬ã€'åœ°æ–¹'åˆ¶åœ§åž‹ã‚·ãƒŸãƒ¥ãƒ¬ãƒ¼ã‚·ãƒ§ãƒ³ã€‚ æ­©å…µã‚„æˆ¦è»Šã¨ã„ã£ãŸç¾ä»£çš„ãªè»éšŠã‚’çŽ‡ã„ã¦æˆ¦ã†ãŒã€ã‚ãã¾ã§ã“ã“ã¯å››å›½ã€‚ çµŒæ¸ˆåŠ›ã¯è²§å¼±ã ã—ã€é£Ÿæ–™è‡ªçµ¦çŽ‡ã‚‚è¶³ã‚Šã¦ã„ãªã„ã€‚é‡è¦ãªç™ºé›»æ‰€ã¯ç‰¹å®šã®ã‚¨ãƒªã‚¢ã«åã£ã¦ã„ã‚‹ã€‚ ã“ã®ã‚ˆã†ãªçŠ¶æ³ä¸‹ã€æ•µã®å‹•å‘ã‚‚è€ƒæ…®ã—ã¤ã¤ã€å†…æ”¿ã¨è»æ‹¡ã‚’è¡Œã„ã€å››å›½çµ±ä¸€ã‚’ç›®æŒ‡ã™ã€‚ â– ãƒ’ãƒ­ã‚¤ãƒ³ã¨å››å›½ã‚’æº€å–«ï¼ ãƒ’ãƒ­ã‚¤ãƒ³ã¨ä¸€ç·’ã«è¦³å…‰ã—ãŸã‚Šã€ç‰¹ç”£å“ã‚’å‘³ã‚ã£ã¦è¦ªç¦ã‚’æ·±ã‚ã‚ˆã†ã€‚ è—æŸ“ä½“é¨“ã€ã‚«ãƒ„ã‚ªæ¼ã€æŸ‘æ©˜é£Ÿã¹æ¯”ã¹ã¨ã„ã£ãŸã€å››å›½ãªã‚‰ã§ã¯ã®ã‚¤ãƒ™ãƒ³ãƒˆãŒè¶…å¤§ç››ã‚Š! â– æ–¹è¨€åŠ¹æžœã§å¯æ„›ã•100000å€! å„çœŒã®ãƒ’ãƒ­ã‚¤ãƒ³ã¯æ–¹è¨€ã£å­ã€‚ ã‚·ãƒŠãƒªã‚ªãŒé€²ã‚“ã§ä»²è‰¯ããªã‚‰ãªã„ã¨ã€æ–¹è¨€ã‚’ä½¿ã‚ãªã„ã‚­ãƒ£ãƒ©ã‚‚ã„ãŸã‚Šã™ã‚‹ã€‚ ç‰¹æ®Šãªè¡¨ç¾ã«ã¯ãƒ«ãƒ“ã‚’æŒ¯ã£ã¦ã„ã‚‹ã®ã§ã€çœŒå¤–ã®äººã«ã‚‚å®‰å¿ƒã ã€‚ â– è±ªè¯ãªã‚°ãƒ©ãƒ•ã‚£ãƒƒã‚¯ ã‚¤ãƒ©ã‚¹ãƒˆãƒ¬ã‚¤ã‚¿ãƒ¼ã€Œå¤©éŸ³è“®äººã€ã•ã‚“æ›¸ãä¸‹ã‚ã—ã®ã‚¤ãƒ©ã‚¹ãƒˆã‚’æŽ¡ç”¨ã€‚ ã•ã‚‰ã«ã¯300æžšè¿‘ã„å››å›½ã®å†™çœŸãŒç‰©èªžã‚’å½©ã‚‹ã€‚ â– ç©¶æ¥µã®å››å›½ã‚²ãƒ¼ æœ¬ä½œã‚’ä½œã‚‹ã«ã‚ãŸã£ã¦ã¯ã€ï¼”å¹´ã«ã‚ãŸã‚‹å–æã‚’è¡Œã£ãŸã€‚ ä½œä¸­ã«ç™»å ´ã™ã‚‹29ã‚‚ã®è‡ªæ²»ä½“ã¸ã®ç¾åœ°å–æã€æ–¹è¨€ç›£ä¿®è€…ã‹ã‚‰ã®æƒ…å ±æä¾›ã€‚ ã•ã‚‰ã«ã¯ç·å‹™çœã€è¾²æž—æ°´ç”£çœã€è³‡æºã‚¨ãƒãƒ«ã‚®ãƒ¼åºã€çµŒæ¸ˆç”£æ¥­çœãªã©ãŒå…¬è¡¨ã—ã¦ã„ã‚‹çµ±è¨ˆãƒ‡ãƒ¼ã‚¿ã‚‚åŽé›†ã—ãŸã€‚ ãã®æˆæžœã¯ä½™ã™ã“ã¨ãªãã‚²ãƒ¼ãƒ ã«åæ˜ ã•ã‚Œã¦ã„ã‚‹ã€‚ è¦³å…‰ã‚„ã‚°ãƒ«ãƒ¡ã€ãƒ’ãƒ­ã‚¤ãƒ³ã¨ã®ã‚¤ãƒãƒ£ãƒ©ãƒ–ã¯ã‚‚ã¨ã‚ˆã‚Šã€æˆ¦ç•¥ã€ç”£æ¥­ã€åœ°ç†ã«é–¢ã‚ã‚‹ã‚¤ãƒ™ãƒ³ãƒˆã‚‚å……å®Ÿã€‚ æµ¦å³¶ä¼èª¬ã€é¬¼ãƒ¶å³¶ä¼èª¬ã€ç©ºæµ·ä¼èª¬ãªã©ã€å››å›½ã«ä¼ã‚ã‚‹ä¼æ‰¿ã‚‚ã‚¹ãƒˆãƒ¼ãƒªãƒ¼ã«å–ã‚Šå…¥ã‚Œã¦ã„ã‚‹ã€‚ â– ä½œé¢¨ã¾ã¨ã‚ å…¨ä½“çš„ã«æ˜Žã‚‹ã„ãƒ©ãƒ–ã‚³ãƒ¡èª¿ã€‚ãã—ã¦è¦³å…‰ã‚„ã‚°ãƒ«ãƒ¡è¦ç´ ã¯ã€ç©ºå‰çµ¶å¾Œã€‚ ä¸€æ–¹ã§SLGéƒ¨åˆ†ã¯ç¡¬æ´¾ã€‚ ãƒãƒ¼ãƒ‰ãƒ¢ãƒ¼ãƒ‰ã§ã¯ã€æ‰‹å¼·ã„è²¡æ”¿é›£ã¨æ•µAIãŒå¾…ã¡æ§‹ãˆã¦ã„ã‚‹ã€‚é›£æ˜“åº¦ã‚’ä¸‹ã’ã‚Œã°ã€æ°—è»½ã«å››å›½ã‚’æº€å–«ã§ãã‚‹ã€‚ â– æ³¨æ„äº‹é … ï½žæ³¨æ„1ï½ž ã“ã®ã‚²ãƒ¼ãƒ ã¯ã€é‡åº¦ã®é£¯ãƒ†ãƒ­ã‚²ãƒ¼ã§ã‚ã‚‹ã€‚ å››å›½å„åœ°ã®ãƒ­ãƒ¼ã‚«ãƒ«ã‚°ãƒ«ãƒ¡ãŒã€ã“ã‚Œã§ã‚‚ã‹ã¨ã„ã†ãã‚‰ã„æ˜ ã—å‡ºã•ã‚Œã‚‹ã€‚ å¤œä¸­ã«éŠã¶æ™‚ã¯ã€ã†ã©ã‚“ã®æº–å‚™ã‚’å¿˜ã‚Œãªã„ã‚ˆã†ã«! ï½žæ³¨æ„2ï½ž ã“ã®ã‚²ãƒ¼ãƒ ã‚’éŠã¶ã¨ã€ãŸã¶ã‚“å››å›½ã«è¡ŒããŸããªã‚‹ã€‚ æ—…è²»ãŒã‹ã‹ã£ã¦ã‚‚çŸ¥ã‚Šã¾ã›ã‚“ã€‚ ï½žæ³¨æ„3ï½ž ä¸€å¿œã“ã®ã‚²ãƒ¼ãƒ ã¯ãƒ•ã‚£ã‚¯ã‚·ãƒ§ãƒ³ã ã€‚æ­£ç¢ºãªè¦³å…‰æƒ…å ±ã¯è‡ªåˆ†ã§ç¢ºèªã—ã‚ˆã†ã€‚",
      ...
      "Score_rank": 1,
      "Recommendations": "",
      "Developers": "Flying Panjandrum / ãµã‚‰ã„ã‚“ããƒ‘ãƒ³ã‚¸ãƒ£ãƒ³ãƒ‰ãƒ©ãƒ",
      "Categories": "Single-player",
